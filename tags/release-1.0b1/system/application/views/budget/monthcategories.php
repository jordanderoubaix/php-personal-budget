...
<?php } ?>
                ...
                <td width="200px" style='text-align: right'><p id="cat_<?=$id?>" style="text-align: right;">$<?=number_format((isset($category['budget_amount'])) ? $category['budget_amount'] : 0, 2)?></p></td>
			...
			<tr>
				<td colspan="9"><div class="cat_sep" width="100%"></div></td>
			</tr>
			<tr id='trans_<?=$id?>' style="display: none; padding-bottom: 10px;">
				<td colspan="1"></td>
				<td colspan="8" style="padding: 5px 0 10px 0px;">
...
?>
	<tr class="category_item budget_total">
		<td colspan="7" style="font-weight: bold; padding-bottom: 0px; padding-top: 0px;">Budget Total</td>
